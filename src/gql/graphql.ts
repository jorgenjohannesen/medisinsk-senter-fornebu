...
export type ContactInformationOrEmployeeOrNewsOrService =
  | ContactInformation
  | Employee
  | News
  | Service
...
} as unknown as DocumentNode<AllPostQuery, AllPostQueryVariables>
export const AllEmployeeDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'allEmployee' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'descriptionRaw' },
                },
                {
                  kind: 'Field',
...
} as unknown as DocumentNode<AllEmployeeQuery, AllEmployeeQueryVariables>
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: '_id' } },
                { kind: 'Field', name: { kind: 'Name', value: 'title' } },
                { kind: 'Field', name: { kind: 'Name', value: 'previewRaw' } },
...
export const ContactInformationDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'allContactInformation' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'where' },
...
>
export const AllServiceDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'allService' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
...
} as unknown as DocumentNode<AllServiceQuery, AllServiceQueryVariables>
